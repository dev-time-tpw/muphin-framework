...
public class WorkflowRunnerTest {
  ...
  public void testConstructorWithTestClassThatHasWorkflowTestAnnotation() {
    ...
    assertThat(executedTestMethod.get(0),
        is(equalTo("testTC1WorkflowABeforeSetupPhase(de.devtime.test.muphin.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(1),
        is(equalTo("testTC1WorkflowAAfterSetupPhase(de.devtime.test.muphin.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(2),
        is(equalTo("testTC1WorkflowABeforeTestPhaseA(de.devtime.test.muphin.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(3),
        is(equalTo("testTC1WorkflowAAfterTestPhaseA(de.devtime.test.muphin.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(4),
        is(equalTo("testTC1WorkflowABeforeTestPhaseB(de.devtime.test.muphin.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(5),
        is(equalTo("testTC1WorkflowAAfterTestPhaseB(de.devtime.test.muphin.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(6),
        is(equalTo("testTC1WorkflowABeforeTearDownPhase(de.devtime.test.muphin.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(7),
        is(equalTo("testTC1WorkflowAAfterTearDownPhase(de.devtime.test.muphin.helper.TestClassA1)")));
  }
  ...
  public void testRun() {
    ...
    assertThat(worklfowBBeforeSetupPhase,
        containsInAnyOrder("testWorkflowBBeforeSetupPhase(de.devtime.test.muphin.helper.TestClassB)"));
  ...
  public void testFilterBeforePhase() throws NoTestsRemainException {
    ...
    Filter filter = new Filter() {
      ...
      @Override
      public boolean shouldRun(Description description) {
        return "testTC1WorkflowABeforeSetupPhase(de.devtime.test.muphin.helper.TestClassA1)"
  ...
  public void testFilterAfterPhase() throws NoTestsRemainException {
    ...
    Filter filter = new Filter() {
      ...
      @Override
      public boolean shouldRun(Description description) {
        return "testTC1WorkflowAAfterSetupPhase(de.devtime.test.muphin.helper.TestClassA1)"
            .equals(description.getDisplayName());
      }
